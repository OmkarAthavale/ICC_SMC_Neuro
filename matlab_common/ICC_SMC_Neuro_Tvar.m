...
function [STATES, CONSTANTS] = initConsts(f_e, f_i)
    ...
    CONSTANTS(:,27) = 180;
    CONSTANTS(:,28) = 10;
    CONSTANTS(:,29) = 0.329454438664630;
    CONSTANTS(:,30) = 0.773384113014197;
    CONSTANTS(:,31) = 0.396950911630671;
    CONSTANTS(:,32) = 0.303891480696183;
    CONSTANTS(:,33) = 1.0;
    CONSTANTS(:,34) = 3.14933156638040;
    CONSTANTS(:,35) = 0.122756641774948;
    CONSTANTS(:,36) = 5;
    STATES(:,9) = 0;
    CONSTANTS(:,37) = 2;
    CONSTANTS(:,38) = 0.3;
